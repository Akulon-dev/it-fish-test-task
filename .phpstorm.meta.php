...
namespace PHPSTORM_META {
    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        '' => '@',
            'App\Repositories\BonusRepositoryInterface' => \App\Repositories\BonusRepository::class,
    ...
    override(\config(), map([
            ...
            'filesystems.links./home/egor/bonus-system/public/storage' => 'string',
            ...
            'l5-swagger.documentations.default.paths.annotations' => 'string',
            ...
            'l5-swagger.defaults.securityDefinitions.security' => 'string',
            ...
            'logging.channels.bonus.driver' => 'string',
            'logging.channels.bonus.path' => 'string',
            'logging.channels.bonus.level' => 'string',
            'logging.channels.bonus.days' => 'integer',
            'mail.default' => 'string',
...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./home/egor/bonus-system/public/storage','ide-helper.filename',
...
'ide-helper.enforce_nullable_relationships','ide-helper.post_migrate','ide-helper.macroable_traits','l5-swagger.default','l5-swagger.documentations.default.api.title',
...
'logging.channels.null.driver','logging.channels.null.handler','logging.channels.emergency.path','logging.channels.bonus.driver','logging.channels.bonus.path',
'logging.channels.bonus.level','logging.channels.bonus.days','mail.default','mail.mailers.smtp.transport','mail.mailers.smtp.scheme',
...
'session.partitioned','cors.paths','cors.allowed_methods','cors.allowed_origins','cors.allowed_origins_patterns',
...
'octane.garbage','octane.max_execution_time','tinker.commands','tinker.alias','tinker.dont_alias',);
...
'l5-swagger.default.api','l5-swagger.default.docs','l5-swagger.default.asset','l5-swagger.default.oauth2_callback','sanctum.csrf-cookie','storage.local',);
        registerArgumentsSet('views', 
'l5-swagger::index','vendor.l5-swagger.index','welcome','l5-swagger::index','laravel-exceptions-renderer::components.card',
